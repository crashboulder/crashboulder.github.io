...
import { IRegion, CircularRegion } from './regions/';
import { CURRENT_ENVIRONMENT } from './environment';
import { Webhook, SlackNotification, IReaction } from './reactions/';
export declare function getConfiguration(): {
    secret: any;
};
export { ApplicationContext, ApplicationAccess, GenericService, IRule, IGeofence, GeofenceService, IObservation, ObservationPayload, ISpeedAlert, SpeedAlertService, IRegion, CircularRegion, ITransition, GeofenceTransition, EnterTransition, ExitTransition, DwellTransition, SpeedTransition, IApplication, IClient, ClientService, Webhook, SlackNotification, IReaction, CURRENT_ENVIRONMENT };
export * from './http/';
